...
function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-12">
      ...
      <Link
        to="/swipe"
        className="cursor-pointer rounded-full bg-[var(--lagoon-deep)] px-8 py-3 text-sm font-semibold text-white no-underline transition-colors hover:opacity-90 dark:text-[var(--sand)]"
      >
        <p className="text-white dark:text-[var(--sand)]">시작하기</p>
      </Link>
    </div>
  );
}
